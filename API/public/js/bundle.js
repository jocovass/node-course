...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9jb3Zhc3MiLCJhIjoiY2s5YmQ4dDJoMDJ0YjNtcGc0dGc2OWVudSJ9.8T1YfJPG3HxkZxObWgHX2g';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add poup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.desciption, "</p>")).addTo(map); //Extends map bounds to include current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logging out. Try again please.');
...
var stripe = Stripe('pk_test_wpj8LHiUOFMh6fHze9zReU7R00dkBMfkMf');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordCurrent = this.elements['password-current'].value;
              password = this.elements.password.value;
              passwordConfirm = this.elements['password-confirm'].value;
              _context.next = 7;
